Rails.application.configure do
  ...
  config.action_controller.asset_host = "aphroditecss.com"
  config.action_mailer.asset_host = "https://www.aphroditecss.com"
  ...
  # config.active_job.queue_name_prefix = "css-manager_#{Rails.env}"
