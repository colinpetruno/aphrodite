...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'has-danger' do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: "text-help"

    b.use :input, class: 'form-control'
    b.use :error, wrap_with: { tag: 'span', class: 'text-help' }
    b.use :hint,  wrap_with: { tag: 'p', class: 'text-help' }
  end
  ...
  config.wrappers :vertical_boolean, tag: 'div', class: 'form-group', error_class: 'has-danger' do |b|
    ...
    b.wrapper tag: 'div', class: 'checkbox' do |ba|
      ba.use :label_input, class: "text-help"
    end
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group row', error_class: 'has-danger' do |b|
    ...
    b.wrapper tag: 'div', class: 'col-sm-9' do |ba|
      ...
      ba.use :error, wrap_with: { tag: 'span', class: 'text-help' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'text-help' }
    end
  end
  ...
  config.wrappers :horizontal_boolean, tag: 'div', class: 'form-group row', error_class: 'has-danger' do |b|
    ...
    b.wrapper tag: 'div', class: 'col-sm-offset-3 col-sm-9' do |wr|
      ...
      wr.use :error, wrap_with: { tag: 'span', class: 'text-help' }
      wr.use :hint,  wrap_with: { tag: 'p', class: 'text-help' }
    end
  end
